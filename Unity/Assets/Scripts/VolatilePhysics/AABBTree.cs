...
namespace Volatile
{
  ...
  /// with an AABB. In the tree we expand the proxy AABBs by 
  /// Config.AABB_PADDING so that the proxy AABB is bigger than the client 
  /// object. This allows the client object to move by small amounts without 
  ...
  public class AABBTree
  {
    ...
    {
      internal const float AABB_PADDING = 0.2f;
    }
    ...
    public AABBTree()
    {
      ...
      this.nodes[this.nodeCapacity - 1].parentOrNextId = 
        AABBTree.NULL_NODE_ID;
